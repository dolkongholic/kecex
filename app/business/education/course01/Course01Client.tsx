    ...
    <section>
      ...
      <main className="w-full md:w-[1400px] flex justify-between items-start m-auto">
        ...
        <div className={`${selectedLiIndex === 0 ? "block" : "hidden"} w-full md:p-[20px]`}>
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-10">1. 방폭안전관리 입문과정 (초급 1)</h4>
            ...
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                방폭의 기본 개념과 안전 절차를 이해하고 기본적인 방폭 장비 사용법을 습득한다.
                </span>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-20">2. 방폭 장비 사용법과 안전 절차 (초급 2)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                방폭 장비의 사용법을 익히고 안전 절차를 준수하는 방법을 배운다.
                </span>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-20">3. 방폭의 기본 개념 및 사고 예방 (초급 3)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
        ...
        <div className={`${selectedLiIndex === 1 ? "block" : "hidden"} w-full md:p-[20px]`}>
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-10">1. 방폭안전관리 향상 (중급 1)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                방폭의 심화 개념을 이해하고, 방폭 장비의 설치 및 유지보수를 할 수 있도록 한다.
                </span>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-20">2. 방폭안전관리 향상 (방폭시스템 점검) 과정 (중급 2)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                방폭의 이해와 실습훈련을 통해 방폭시설에 대한 자체 점검을 통해 유지관리할 수 있는 역량을 강화한다.
                </span>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-20">3. 방폭설비 유지보수 과정 (중급 3)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                방폭설비의 유지보수 및 점검을 통해 안전성을 향상시키는 방법을 학습한다.
                </span>
              </div>
            </div>
        ...
        <div className={`${selectedLiIndex === 2 ? "block" : "hidden"} w-full md:p-[20px]`}>
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-10">1. 방폭지역 관리향상 및 전기화재 예방과정 (고급 1)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                방폭 관련 법규 및 설치기준, 방폭구조, 방폭기기에 대한 지식을 습득하고 이해 수준을 높여 방폭 지역에 대한 안전관리를 향상시키고 전기적인 요소로 인한 화재 사고를 예방한다.
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                <span>
                방폭지역이 존재하는 사업장의 안전관리자, 안전환경팀 재직자, PSM 안전관계자 및 관리감독자
                </span>
              </div>
            </div>
            ...
            <div className="w-full mb-[20px]">
              <ul className="flex flex-col space-y-1 md:p-[20px] md:border border-gray w-full">
                ...
                <li>5.	방폭 장비의 Cable Entry에 대한 요구 사항, 설치 확인</li>
              </ul>
            </div>
          ...
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-20">2. IECEx Standard 해설과정 (고급 2)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                방폭에 관련된 국제 표준에 대한 이해를 돕고 기준에 맞는 올바른 해설을 통해 사고 예방에 기여한다.
                </span>
              </div>
            </div>
        ...
        <div className={`${selectedLiIndex === 3 ? "block" : "hidden"} w-full md:p-[20px]`}>
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-10">1. PSM 자체 검사 및 이행 평가과정 (특급 1)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                PSM 사업장의 공정안전관리 자체 감사 및 이행 평가에 대한 기술적 사항을 토대로 PSM 등급 향상 방안과 능력을 배양한다.
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                <span>
                공정안전보고서(PSM) 제출 대상 사업장의 담당자, 공정안전 시스템 자체 운영 사업장, OSHAS 또는 KOSHA 18001 적용 사업장
                </span>
              </div>
            </div>
          ...
          <div>
            <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-20">2. PSM 위험성 평가 기법 해설 및 적용 실무과정 (특급 2)</h4>
            <ContentSubTitle title="교육목적" />
            <div className="w-full mb-[20px]">
              <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                <span>
                PSM 사업장의 공정안전보고서 심사, 확인, 이행 평가 전 과정에 적용되는 위험성 평가 기법을 체계적으로 교육하여 자체 수행 능력을 향상시킨다.
                </span>
              </div>
            </div>
