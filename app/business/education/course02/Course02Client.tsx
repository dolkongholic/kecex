    ...
    <section>
      ...
      <main className="w-full md:w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="px-[15px] py-[40px] md:pl-[50px] md:pr-[20px] w-full flex flex-col justify-start items-start">
            ...
            <div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    공정안전관리(PSM)에 대한 이해를 높이고, 이를 통해 산업
                    현장에서의 안전성을 강화한다.
                  </span>
                </div>
              </div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                  <span>공정안전관리 담당자, 안전관리자, 관련 업무 종사자</span>
                </div>
              </div>
          ...
          >
            <div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    물질안전보건자료(MSDS)의 중요성을 이해하고, 올바르게
                    활용하는 방법을 익힌다.
                  </span>
                </div>
              </div>
          ...
          >
            <div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    산업 현장에서 화재와 폭발을 예방하는 방법을 익히고, 비상
                    상황에 대처하는 능력을 배양한다.
                  </span>
                </div>
              </div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                  <span>안전관리자, 산업 현장 작업자, 화재 예방 담당자</span>
                </div>
              </div>
          ...
          >
            <div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    밀폐공간 작업 시 발생할 수 있는 위험을 이해하고, 이를
                    예방하기 위한 안전 절차를 익힌다.
                  </span>
                </div>
              </div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                  <span>밀폐공간에서 작업하는 작업자, 안전관리자</span>
                </div>
              </div>
          ...
          <div
            className={`${
              selectedLiIndex === 4 ? "block" : "hidden"
            } w-full md:p-[20px]`}
          >
            <div>
              <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-10">
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    산업안전보건법에 대한 이해를 높이고, 법규를 준수하여 안전한
                    작업 환경을 조성한다.
                  </span>
                </div>
              </div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                  <span>안전관리자, 산업안전보건 담당자, 관련 업무 종사자</span>
                </div>
              </div>
          ...
          <div
            className={`${
              selectedLiIndex === 5 ? "block" : "hidden"
            } w-full md:p-[20px]`}
          >
            <div>
              <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-10">
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    화학물질의 안전한 관리와 사용 방법을 이해하고, 이를 통해
                    사고를 예방한다.
                  </span>
                </div>
              </div>
          ...
          <div
            className={`${
              selectedLiIndex === 6 ? "block" : "hidden"
            } w-full md:p-[20px]`}
          >
            <div>
              <h4 className="text-[18px] md:text-xl font-semibold underline underline-offset-4 mt-10">
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    근로자의 안전 인식을 높이고, 안전한 작업 환경을 유지하기
                    위한 역량을 강화한다.
                  </span>
                </div>
              </div>
