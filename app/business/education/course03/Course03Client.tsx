      ...
      <main className="w-full md:w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="px-[15px] py-[40px] md:pl-[50px] md:pr-[20px] w-full flex flex-col justify-start items-start">
          ...
          <ul className="w-full flex flex-wrap text-[13px] md:text-base mt-10 md:mt-0">
            ...
            >
              위험성 평가 및<br className="md:hidden" /> HAZOP 과정
              <br className="md:hidden" /> (정성적 평가 1)
              <Image
                src={content_icon}
            ...
            >
              위험성 평가 및<br className="md:hidden" /> JSA 과정
              <br className="md:hidden" /> (정성적 평가 2)
              <Image
                src={content_icon}
                className={`w-4 md:w-6 mr-5 ${
            ...
            <div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    산업 현장에서의 위험성을 평가하고, HAZOP(위험성 및 운전성
                    연구) 기법을 이해하여 적용하는 방법을 학습한다.
                  </span>
                </div>
              </div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                  <span>안전관리자, 위험성 평가 담당자, HAZOP 기법 적용자</span>
                </div>
              </div>
          ...
          >
            <div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full leading-[30px]">
                  <span>
                    Job Safety Analysis(JSA) 기법을 이해하고 적용하여
                    작업장에서의 위험성을 평가하고 관리한다.
                  </span>
                </div>
              </div>
              ...
              <div className="w-full mb-[20px]">
                <div className="flex flex-col justify-center items-start md:p-[20px] md:border border-gray w-full">
                  <span>안전관리자, 위험성 평가 담당자, JSA 기법 적용자</span>
                </div>
              </div>
