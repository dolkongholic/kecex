        ...
        <section className="py-[40px] px-[15px] md:pl-[50px] md:pr-[20px] w-full flex flex-col justify-start items-start">
          ...
          <div className="w-full pb-[15px] mt-[10px] mb-[40px]">
            ...
            <div className="md:flex">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                회원은 일반회원, 정회원, 기업회원, 명예회원등으로 구분한다.
              </div>
            </div>
            <div className="md:flex">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                학생(대학원생 포함) 및 개인이 가입원서와 회비를 납부한 자로 하며
                총회에 의결권이 없다.
              </div>
            </div>
            <div className="md:flex">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                ...
                협회 활동에 의견을 제안하고 의결에 참여할 권리가 있다.
              </div>
            </div>
            <div className="md:flex">
              <span className=" text-secondary w-[220px] text-[15px] md:text-base text-center md:text-start mt-2 md:mt-1">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                기업회원은 기업체 등에서 가입하는 것으로 기업회원 가입 제한
                규정은 이사회에서 별도로 정하여 시행한다.
              </div>
            </div>
            <div className="md:flex">
              <span className=" text-secondary w-[220px] text-[15px] md:text-base text-center md:text-start mt-2 md:mt-1">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                이사회 의결을 거쳐 회장이 추천하는 기업체·단체 및 개인으로 하며
                기부금조로 일부 회비를 납부할 수 있다.
              </div>
            </div>
          </div>
          ...
          <div className="w-full pb-[15px] mt-[10px] mb-[40px] text-[15px] md:text-base">
            <div className="md:flex pb-[15px]">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                신규 회원이 되고자하는 자는 정해진 {`'회원가입 신고서'`}(서식
                1)를 본 협회에 제출하면서 가입비와 연회비를 납부하며, 기존회원은
                연회비를 납부한다.
              </div>
            </div>
            <div className="md:flex">
              ...
              <div className="">
                <div className="w-full flex justify-start items-end text-[15px] md:text-base">
                  ① 【일반회원】은 정해진 회원가입 신고서 제출 및 회비를 납부한
                  자로 한다.
                </div>
                <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                  ② 【정회원】, 【기업회원】, 【명예회원】은 정해진 회원가입
                  신고서를 제출한 자 중에서 이사회에서 심의·의결을 거쳐 최종
                  승인을 받은 자로 한다.
                </div>
              </div>
            </div>
          ...
          <div className="w-full pb-[20px] mt-[10px] mb-[40px]">
            ...
            <div className="md:flex pb-[20px]">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                ① 일반회원, 명예회원은 협회의 자료 및 출판물을 제공받으며,
                협회운영에 관한 자료를 열람할 수 있으며, 세미나·강연 및
                기타협회에서 행하는 행사와 활동에 참여할 수 있다. 다만, 총회
                개최 시 의결권이 없다.
              </div>
            </div>
            <div className="md:flex pb-[20px]">
              ...
              <div className="w-full pt-[2px] flex flex-col justify-start items-start text-[15px] md:text-base">
                ① 회원의 회비는 일반회원비, 정회원비, 기업회원비, 명예회원비로
                구분하며, 이사회를 통해 회비를 정한다.(정관 제5조 회원의 자격,
                ...
                <table className="w-full block h-auto my-3 text-center border-y-2 border-[#3A3A3A] text-[13px] md:text-[15px]">
                  <div className="flex border-b  border-[#3A3A3A] items-center">
                    ...
                    <th className="w-1/5 border-r border-[#3A3A3A]">
                      일반회원
                    </th>
                    <th className="w-1/5 border-r border-[#3A3A3A]">정회원</th>
                    <th className="w-1/4 md:w-1/5 border-r border-[#3A3A3A]">
                      기업회원
                    </th>
                  ...
                  <div className="flex">
                    ...
                    <td className="w-1/5 border-r border-[#3A3A3A]">
                      20,000원
                    </td>
                    <td className="w-1/5 border-r border-[#3A3A3A]">
                      100,000원
                    </td>
                    <td className="w-1/4 md:w-1/5 border-r border-[#3A3A3A] whitespace-nowrap">
                      1,000,000원
                    </td>
                  ...
                  <div className="flex">
                    ...
                    <td className="w-1/4 md:w-1/5 border-r border-[#3A3A3A]">
                      500,000원
                    </td>
                    <td className="w-[18%] md:w-1/5">-</td>
                  </div>
            ...
            <div className="md:flex pb-[20px]">
              ...
              <div className="w-full pt-[2px] flex justify-start items-end text-[15px] md:text-base">
                ...
                <br />
                ④ 회원의 윤리·품위 유지·실천 의무
                <br />⑤ 정관 및 제반규정으로 정하는 각종 자료제출과 보고에
                회원으로서 적극적 협조
              </div>
            </div>
            <div className="md:flex pb-[20px]">
              ...
              <div className="w-full pt-[2px] flex flex-col justify-start items-start text-[15px] md:text-base">
                ...
                <br />⑤ 정회원 및 기업회원이 실시하는 행사 및 관련 자료 제작시
                협회 로고를 사용할 수 있으나 협회에 사전 승인을 요청 후 사용
              </div>
            </div>
          </div>
          ...
          <div className="w-full pb-[15px] mt-[10px]">
            ...
            <div className="w-full pt-[2px] pb-[5px] flex justify-start items-end text-[15px] md:text-base mb-[5px]">
              ① 회원은 본인의 의사에 따라 {`'회원탈퇴서'(서식2)`}를 제출함으로써
              자유롭게 탈퇴할 수 있다.
            </div>
            <span className="text-secondary w-[180px] text-[15px] md:text-base">
              제2조 (회원의 제명)
          ...
          <div className="w-full pb-[15px] mt-[10px] mb-[40px]">
            <div className="md:flex">
              ...
              <div className="w-full pt-[2px] md:pl-[10px] pb-[5px] flex justify-start items-end text-[15px] md:text-base mb-[5px]">
                ...
                <br />② 협회는 회원이 아닌 자·단체·업체가 타의 귀감이 되고
                협회와 방폭산업계에 공헌하였을 경우 이사회의 의결로 포상할 수
                있다.
              </div>
            </div>
            <div className="md:flex">
          ...
          <div className="flex">
            ...
            >
              ...
              <Image
                src={download_icon}
                className="w-5 h-5 inline ml-1 mb-1"
                alt="img"
              />{" "}
            </button>
            <button
