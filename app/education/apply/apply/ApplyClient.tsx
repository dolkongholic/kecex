...
const ApplyClient = () => {
  ...
  return (
    <section>
      ...
      <main className="w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="py-[20px]  pl-[40px] w-full flex flex-col justify-start items-start">
          ...
          <div className="flex justify-between w-full h-[50px] leading-[50px]">
            <Link passHref href="/education/apply/apply" className="w-1/5">
            ...
            <Link passHref href="/education/apply/restudy" className="w-1/5">
              <div className="w-full text-center h-full border border-gray-200 cursor-pointer">
                재교육 신청
              </div>
            </Link>
            <Link passHref href="/education/apply/reexam" className="w-1/5">
              <div className="w-full text-center h-full border border-gray-200 cursor-pointer">
                재시험 신청
              </div>
            </Link>
            <Link passHref href="/education/apply/semina" className="w-1/5">
              <div className="w-full text-center h-full border border-gray-200 cursor-pointer">
                세미나 신청
              </div>
            </Link>
            <Link passHref href="/education/apply/consulting" className="w-1/5">
              <div className="w-full text-center h-full border border-gray-200 cursor-pointer">
                컨설팅 신청
              </div>
            </Link>
          ...
          <div className="flex text-title justify-center items-center text-black w-full h-[180px] p-[40px] bg-lightgray">
            ...
            <input
              type="text"
              className="w-[600px] h-[50px] border border-neutral-300 rounded-l-md border-r-0 pl-[40px] pr-[10px] leading-[50px] text-[14px] placeholder:text-[14px] placeholder:leading-[50px]"
          ...
          <div className="mt-[30px] w-full h-full">
            <div className="w-full text-black text-[14px] border-b border-secondary leading-[50px]">
              <div className="flex justify-between">
                ...
                >
                  교육 등록{" "}
                  <GrAddCircle className="inline w-5 h-5 ml-1 mb-0.5" />
                </button>
              </div>
            </div>
            {[1, 2, 3, 4, 5, 6, 7].map((item, index) => (
              ...
              >
                ...
                <div className="flex flex-col justify-center  items-center">
                  ...
                  <button
                    className="flex justify-center items-center bg-gray-200 hover:bg-[#ccc]  w-[150px] h-[30px] pop_open_btn mt-3"
                    onClick={openModal}
                  >
          ...
          <div
            id="pop_wrap_01"
            className={`w-[1100px] h-[700px] fixed z-[101] inset-1/2 -mx-[550px] -my-[400px] ${
              isPopupOpen && activePopup === "pop_wrap_01" ? "" : "hidden"
            }`}
          >
            <div className="w-[1100px] h-auto flex justify-end">
              <button
                id="close_btn"
                className="w-12 h-12 bg-primary text-white rounded-t-md"
                onClick={() => {
                  handleClose();
                  closePopup();
                }}
            ...
            >
              ...
              <form
                ...
                className="flex"
              >
                <div className="w-40 h-60 bg-gray-100">
                  ...
                  <label
                    htmlFor="fileInput"
                    className="inline-block py-4 pl-10 w-full h-14 bg-primary text-white cursor-pointer"
                  >
                    첨부파일
                  </label>
                </div>
                ...
                <div className="form_area p-5 w-full">
                  <p className="text-[14px] text-active">
                    * 개인정보는 필수입니다.
                  </p>
                  <fieldset className="border border-gray-200 text-center w-full mt-3 text-black">
                    <legend className="w-32 h-14 float-left pt-4 text-left pl-7">
                      성명(한글)
                    </legend>
                    <div className="before:border-l before:border-gray-200 :w-40 h-14 float-left pt-2">
                      <input
                        type="text"
                        placeholder="성"
                        className="pl-4 h-10 w-40"
                      />
                    </div>
                    <div className="before:border-l before:border-gray-200 w-[300px] h-14 float-left p-2">
                      <input
                        type="text"
                        placeholder="이름"
                        className="pl-4 h-10"
                  ...
                  <fieldset className="border border-gray-200 text-center mt-3 text-black w-[49%] float-left">
                    <legend className="w-32 h-14 float-left pt-4 text-left pl-7">
                      생년월일
                    </legend>
                    <div className="before:border-l before:border-gray-200 :w-40 h-14 float-left pt-2">
                  ...
                  <fieldset className="border border-gray-200 text-center mt-3 text-black w-[49%] float-left ml-[2%]">
                    <legend className="w-32 h-14 float-left pt-4 text-left pl-7">
                      이메일
                    </legend>
                    <div className="before:border-l before:border-gray-200 :w-40 h-14 float-left pt-2">
                  ...
                  <fieldset className="border border-gray-200 text-center mt-3 text-black w-[49%] float-left mb-3">
                    <legend className="w-32 h-14 float-left pt-4 text-left pl-7">
                      연락처(HP)
                    </legend>
                    <div className="before:border-l before:border-gray-200 :w-40 h-14 float-left pt-2">
                  ...
                  <fieldset className="border border-gray-200 text-center w-full text-black">
                    <legend className="w-52 h-14 float-left pt-4 text-left pl-7">
                      자택주소 (우편주소지)
                    </legend>
                    <div className="before:border-l before:border-gray-200 h-14 float-left pt-2">
                      <input
                        type="text"
                        placeholder=""
                        className="pl-4 h-10 w-[450px]"
                        id="address_input_1"
                        value={addressInput1}
                      />
                      <button
                        type="button"
                        className="w-24 h-10 bg-primary text-white text-[14px]"
                        onClick={() => handleInputClick("address_input_1")}
                        value={addressInput1}
                      >
                        검색
                      </button>
                  ...
                  <fieldset className="border border-gray-200 text-center w-full mt-3 text-black">
                    <div className="h-14 float-left pt-2 pl-7">
                      <input
                        type="text"
                        placeholder="나머지 주소"
                        className="h-10 w-[680px]"
                      />
                    </div>
                  </fieldset>

                  <p className="mt-10 text-active text-[14px]">
                    * 재직자가 아닐경우 비워두시면 됩니다.
                  </p>
                  <fieldset className="border border-gray-200 text-center w-full text-black mt-3">
                    <legend className="w-32 h-14 float-left pt-4 text-left pl-7">
                      회사명
                    </legend>
                    <div className="before:border-l before:border-gray-200 :h-14 float-left pt-2">
                  ...
                  <fieldset className="border border-gray-200 text-center w-full text-black">
                    ...
                    <div className="before:border-l before:border-gray-200 :h-14 float-left pt-2">
                      ...
                      <button
                        type="button"
                        className="w-24 h-10 bg-primary text-white text-[14px]"
                        onClick={() => handleInputClick("address_input_2")}
                        value={addressInput2}
                      >
                        검색
                      </button>
                  ...
                  <p className="mt-10 text-active text-[14px]">
                    * 입금계좌정보와 현금영수증 발급여부를 확인하세요.
                  </p>
                  <p className="mt-6 text-active text-[14px]">
                    * 세금 계산서 별도 문의 바랍니다.
                  </p>
                  <p className="mt-6 text-active text-[14px]">
                    * 본인 성명으로 입금하여야 확인 가능하며 입금 확인 후 접수
                    완료됩니다.
                  </p>
                  <fieldset className="border border-gray-200 text-center w-full text-black mt-5">
                    <legend className="w-52 h-14 float-left pt-4 text-left pl-7">
                      입금계좌정보 안내
                    </legend>
                    <div className="before:border-l before:border-gray-200 :w-52 h-14 float-left pt-2">
                      <input
                        type="text"
                  ...
                  <fieldset className="border border-gray-200 text-center w-full text-black mt-3">
                    ...
                    <div className="before:border-l before:border-gray-200 :w-52 h-14 float-left pt-2">
                      <input
                        type="text"
                        placeholder="121만원"
                        className="pl-4 h-10 w-40 placeholder:text-primary placeholder:text-[20px] placeholder:font-bold bg-white"
                        disabled
                      />
                    </div>
                  </fieldset>
                  <fieldset className="border border-gray-200 text-center w-full text-black mt-3">
                    ...
                    <div className="before:border-l before:border-gray-200 before:h-6 w-52 h-14 float-left pt-2 flex items-center ">
                      <input
                        type="radio"
                        name="issue_chk"
                  ...
                  <fieldset className="border border-gray-200 text-center w-full text-black mt-3">
                    <legend className="w-52 h-20 float-left pt-4 text-left pl-7">
                      발급번호
                    </legend>
                    <div className="before:border-l before:block before:h-16 before:mt-2 before:absolute before:border-gray-200 :w-52 h-20 float-left relative">
                      <input
                        type="text"
                        placeholder="입력"
                        className="pl-4 h-10 w-52 mt-2"
                      />
                    </div>
                    <p className="max-h-20 text-active text-[14px] mt-2">
                      ① 개인소득공제용 : 휴대폰번호 <br />
                      &nbsp;&nbsp;&nbsp; ② 사업자증빙용 : 사업자등록번호
                    </p>
                  </fieldset>
              ...
              <div className="form_btn_box flex justify-center mt-5">
                <a href="#">
                  <button className="w-32 h-12 bg-active text-white">
                    확인
                  </button>
                </a>
                <a href="#">
          ...
          {/* 교육등록 팝업 시작 */}
          <div
            id="pop_wrap_register"
            className={`w-[1100px] h-[700px] fixed z-[101] inset-1/2 -mx-[550px] -my-[400px] ${
              isPopupOpen && activePopup === "pop_wrap_register" ? "" : "hidden"
            }`}
          >
            <div className="w-[1100px] h-auto flex justify-end">
              <button
            ...
            >
              ...
              <fieldset className="border border-gray-200 text-center w-full mt-3 text-black">
                ...
                <div className="before:border-l before:border-gray-200 :w-full h-14 float-left pt-2">
              ...
              <fieldset className="border border-gray-200 text-center mt-3 text-black w-full float-left">
                <legend className="w-40 h-14 float-left pt-4 text-left pl-7">
                  교육제목
                </legend>
                <div className="before:border-l before:border-gray-200 :w-40 h-14 float-left pt-2">
                  <input
              ...
              <fieldset className="border border-gray-200 text-center mt-3 text-black w-full float-left">
                ...
                <div className="before:border-l before:border-gray-200 before:h-6 w-40 h-14 float-left flex items-center">
                  <input
                    type="text"
                    placeholder=""
                    className="pl-4 h-10 w-44"
              ...
              <fieldset className="border border-gray-200 text-center mt-3 text-black w-full float-left">
                ...
                <div className="before:border-l before:border-gray-200 before:h-6 h-14 float-left flex items-center">
                  <input
                    type="text"
                    placeholder=""
                    className="pl-4 h-10 w-44"
              ...
              <div className="flex w-full justify-between mt-5">
                ...
                <div className="form_btn_box flex justify-center mt-5">
                  ...
                  <a href="#">
                    <button
                      className="w-32 h-10 bg-gray-100 ml-6 text-[15px]"
                      onClick={closePopup}
                    >
                      취소
                    </button>
      ...
      <div
        id="pop_screen_bg"
        className={`h-screen w-screen bg-opacity-50 bg-black fixed left-0 top-0 z-[100] ${
          isPopupOpen ? "" : "hidden"
        }`}
      ></div>
    </section>
