      ...
      <main className="w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="py-[20px]  pl-[40px] w-full flex flex-col justify-start items-start">
          ...
          <div className="w-full flex justify-center items-center mt-[50px]">
            <button className="w-[200px] h-[50px] bg-secondary flex justify-center items-center text-white">
              본인인증
            </button>
          </div>
          ...
          {[1, 2, 3, 4, 5].map((item, index) => (
            <div
              key={index}
              className="flex px-[40px] py-[20px] justify-between items-center w-full border-b border-gray hover:shadow-md"
            >
              <div className="flex">
                ...
                >
                  ...
                  {index == 1 && (
                    <div className="flex justify-center items-center ml-[20px]">
                      <div className="flex bg-secondary_light opacity-80 px-[10px]">
              ...
              <div className="flex-col space-y-[7px]">
                <div className="text-superdarkgray">
                  <span className="text-darkgray mr-[10px]">교육기간</span>{" "}
                  2023.11.15 ~ 2023.11.16, 09:00 ~ 18:00
                </div>
                <div className="text-superdarkgray">
                  <span className="text-darkgray mr-[10px]">교육장소</span>{" "}
                  울산교육장
                </div>
                <div className="text-superdarkgray">
                  <span className="text-darkgray mr-[25px]">수료자</span> 김영호
                  850320-1******
                </div>
              </div>
            </div>
