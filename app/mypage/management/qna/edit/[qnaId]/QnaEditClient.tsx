...
interface QnaEditClientProps {
  currentQna?: any;
  currentUser?: any;
}

const QnaEditClient: React.FC<QnaEditClientProps> = ({
  currentQna,
  currentUser,
}) => {
  ...
  const onSubmit: SubmitHandler<FieldValues> = (data) => {
    ...
    axios
      .post("/api/modify/qnaEdit", {
        title: data.title,
        content: data.content,
        qnaId: qnaId,
      })
      .then(() => {
        toast.success("문의 답변을 수정했습니다.");
      })
      .catch(() => {
    ...
    <section>
      ...
      <main className="w-full md:w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="py-[40px] md:pl-[50px] md:pr-[20px] w-full flex flex-col justify-start items-start">
          <ContentTitle title="1:1문의 답변 수정" center={true} />
          ...
          <div className=" w-full">
            <div className="w-full pl-[20px] flex justify-start items-center h-[60px] bg-gray-100 border-t-2 border-gray-500">
              <div className="w-[937px] overflow-hidden line-clamp-1 px-[10px]">
