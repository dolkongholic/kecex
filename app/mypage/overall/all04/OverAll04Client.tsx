        ...
        <section className="p-[20px] w-full flex flex-col justify-start items-start">
          ...
          <div className="text-black w-full flex flex-col justify-between item-center -translate-y-[19px]">
            ...
            {[1, 2, 3, 4, 5, 6, 7].map((item, index) => (
              <div
                key={index}
                className="border-b border-gray-100 px-[40px] py-[25px] flex justify-between items-center hover:shadow-md"
              >
...
export default OverAll04Client;
