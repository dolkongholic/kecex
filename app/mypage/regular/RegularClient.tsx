      ...
      <main className="w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="p-[20px] w-full flex flex-col justify-start items-start">
          ...
          <div className="text-black w-full flex flex-col justify-center item-center">
            <div className="w-2/3 h-24 border border-blue-500 rounded-lg flex justify-center items-center px-10 m-auto my-10">
            ...
            <ul className="border border-[#ccc] w-full h-36 flex mb-9">
              <li className="flex items-center justify-center w-1/4 border-r border-[#ccc]">
                안전보건관리책임자
              </li>
              <li className="flex items-center justify-center w-1/4 border-r border-[#ccc]">
                관리감독자
            ...
            <ul className="-translate-y-[20px] text-[15px] leading-6 mb-5">
              <li className="w-full border-b border-gray-200 flex">
                <div className="w-1/2 h-36 flex items-center">
                  <div className="w-20 h-20 border border-[#ccc] rounded-full flex justify-center items-center text-[30px] text-[#ccc]">
                    1
                  </div>
                  <p className="ml-3">
              ...
              <li className="w-full border-b border-gray-200 flex">
                ...
                <div className="w-1/2 h-36 flex items-center">
                  ...
                  <p className="ml-3">국내 산업안전관리 우수업체 시찰</p>
                </div>
              </li>
              <li className="w-full border-b border-gray-200 flex">
                <div className="w-1/2 h-36 flex items-center">
                ...
                <div className="w-1/2 h-36 flex items-center">
                  ...
                  <p className="ml-3">각종 산업안전관련 행사 우선 초청</p>
                </div>
              </li>
              <li className="w-full border-b border-gray-200 flex">
                <div className="w-1/2 h-36 flex items-center">
                  ...
                  <p className="ml-3">산업재해예방에 기여한 우수회원 표창</p>
                </div>
                <div className="w-1/2 h-36 flex items-center">
                  <div className="w-20 h-20 border border-[#ccc] rounded-full flex justify-center items-center text-[30px] text-[#ccc]">
                    8
            ...
            <div className="btn_box flex m-auto mt-20">
              <button className="w-44 h-14 bg-blue-500 text-white flex justify-center items-center">
                입회원서 다운로드{" "}
                <Image
