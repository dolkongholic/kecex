...
const ServiceInfoClient: React.FC<ServiceInfoProps> = ({ currentUser }) =>{
        ...
        <section className="p-[20px] w-full flex flex-col justify-start items-start">
          ...
          <div className="flex justify-center mt-[30px] md:mt-[90px] mx-auto">
            <div className="md:w-[900px] mx-auto">
              <p>
                <span className="text-[24px] font-medium">회원가입 이용자 약관</span><br/><br/>

                <span className="text-[18px] font-medium">제 1 장 총칙</span><br/><br/>
                ...
                ② 이용자라 함은 개인, 기업 관계자 뿐만 아니라 일반 사용자 등의 이용계약 체결 여부와 관계없이 한국방폭협회를 활용하는 모든 대상<br/>
                ③ 아이디(ID)라 함은 이용자 식별과 이용자의 서비스 이용을 위하여 이용계약 체결 시 이용자가 설정한 문자와 숫자의 조합<br/>
                ④ 비밀번호라 함은 이용자 자신의 비밀을 보호하기 위하여 이용자 자신이 설정한 문자와 숫자의 조합<br/>
                ⑤ 서비스라 함은 이용자가 단말기를 이용하여 한국방폭협회의 주전산기에 접속하여 다양한 정보를 입력·활용하는 것<br/>
                ⑥ 이용계약이라 함은 한국방폭협회의 서비스를 제공받기 위하여 이 약관으로 한국방폭협회와 이용자 간의 체결하는 계약<br/><br/>

                제 3 조 (약관의 효력과 변경)<br/>
                ① 이 약관은 한국방폭협회에 게시하여 가입함으로써 효력을 발생합니다.<br/>
                ② 한국방폭협회는 합리적인 사유가 발생한 경우에는 이 약관을 변경할 수 있으며, 약관을 변경한 경우에는 변경 내용을 최소 7일 이전에 공시합니다.<br/>
                ③ 등록자는 변경된 약관 사항에 동의하지 않으면, 언제나 서비스 이용을 중단하고 이용계약을 해지할 수 있습니다. 약관의 효력 발생일 이후의 계속적인 
                서비스 이용은 약관의 변경 사항에 등록자가 동의한 것으로 간주됩니다.<br/><br/>
                ...
                <span className="text-[18px] font-medium">제 2 장 서비스 이용 계약</span><br/><br/>
                ...
                <span className="text-[18px] font-medium">제 3 장 서비스의 이용</span><br/><br/>

                제 9 조 (서비스 이용시간)<br/>
                서비스의 이용 시간은 한국방폭협회 업무 및 기술상 특별한 지장이 없는 한 연중무휴, 1일 24시간(00:00-24:00)을 원칙으로 합니다. 
                다만 정기점검 등의 필요로 한국방폭협회가 정한 날이나 시간은 그러하지 아니합니다. 또한 서비스의 중지 및 제한에 대해서는 별도의 조항에 따릅니다.<br/><br/>
                ...
                ① 한국방폭협회는 서비스용 설비의 용량에 여유가 없다고 판단하는 경우 관련 사항을 사전 공지 후 필요에 따라 이용자가 게재 또는 등록한 내용물을 삭제하거나 
                이용자의 서비스 이용을 부분적으로 제한할 수 있습니다.<br/>
                ...
                <span className="text-[18px] font-medium">제 4 장 의무</span><br/><br/>
                ...
                제 14 조 (개인정보보호)<br/>
                ① 한국방폭협회는 공공기관의 정보공개에 관한 법률, 정보통신망 이용촉진 등에 관한 법률 등 관계 법령에 따라 이용신청 시 제공 받는 
                이용자의 개인정보, 이후에 추가로 제공받는 개인정보 및 서비스 이용 중 생성되는 개인정보를 보호하여야 합니다.<br/>
                ...
                ④ 이용자는 언제나 이용계약을 해지함으로써 개인정보의 수집 및 이용에 대한 동의, 목적 외 사용에 대한 별도 동의, 제3자 제공에 대한 별도 동의를 철회 할 수 있습니다. 
                해지는 회원이 원하는 경우 한국방폭협회의 해지절차를 통해 하실 수 있습니다.<br/><br/>

                제 15 조 (이용자의 의무) ① 이용자는 서비스를 이용할 때 다음 각 호의 행위를 하지 않아야 합니다.<br/>
                ...
                <span className="text-[18px] font-medium">제 5 장 저작권 및 면책</span><br/><br/>
                ...
                제 18 조 (면책)<br/>
                한국방폭협회는 이용자간 또는 이용자와 제3자간에 서비스를 매개로 하여 물품거래 혹은 금전적 거래 등과 관련하여 어떠한 책임도 부담하지 아니하고, 
                이용자가 서비스의 이용과 관련하여 기대하는 이익에 관하여 책임을 부담하지 않습니다. 이용자가 한국방폭협회에서 제공하는 서비스 자료에 대한 취사선택 또는 
                이용으로 발생하는 손해 등에 대해서는 한국방폭협회의 책임이 면제됩니다.<br/><br/>
...
export default ServiceInfoClient;
