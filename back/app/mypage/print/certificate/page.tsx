      ...
      <main className="w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="p-[20px] w-full flex flex-col justify-start items-start">
          ...
          <div className="text-black w-full flex flex-col justify-between item-center border-b-secondary border-b-2">
            <div className="h-[40px]">본 협회에서 발급된 증서를 출력하실 수 있습니다.</div>
          </div>
          <figure className="w-full flex justify-center my-10">
            <div src={certificate_bg} className="w-[620px] h-[877px] border border-gray relative">
                <Image src={certificate_bg} className="absolute left-0 top-0"/>{" "}
                ...
                <p className="absolute left-[173px] top-[539px] z-40 text-[12px] font-[KoPubWorldBatang] text-[#898989]">2023.03.06</p>
                <p className="absolute left-[348px] top-[539px] z-40 text-[12px] font-[KoPubWorldBatang] text-[#898989]">2024.03.06</p>
          ...
          <div className="btn_box flex m-auto mt-20">
            <button className="w-40 h-14 border border-gray text-superdarkgray flex justify-center items-center">
              다운로드 <Image src={download_icon} className="w-4 h-4 ml-2"/>{" "}
            </button>
