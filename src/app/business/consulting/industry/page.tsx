      ...
      <main className="w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="py-[20px]  pl-[40px] w-full flex flex-col justify-start items-start">
          ...
          <ul className="w-full mt-10">
            <li className={`${selectedLiIndex === 0 ? 'block' : 'hidden'}`}>{/*PSM 컨설팅 */}
              ...
              <li className="w-full border-b border-gray flex">
                ...
                <div className="w-1/2 h-32 flex items-center">
                  ...
                  <p className="ml-3">PSM 자체감사 컨설팅(점검 면제용 포함)</p>
                </div>
              </li>
              <li className="w-full border-b border-gray flex">
                <div className="w-1/2 h-32 flex items-center">
                  ...
                  <p className="ml-3">
                    공정위험성평가 컨설팅(HAZOP, K-PSR, LOPA, What-If,<br />
                ...
                <div className="w-1/2 h-32 flex items-center">
                  ...
                  <p className="ml-3">PSM 운영 System 구축(Web 전산 프로그램)</p>
                </div>
              </li>
              <li className="w-full border-b border-gray flex">
                <div className="w-1/2 h-32 flex items-center">
                  ...
                  <p className="ml-3">폭발위험장소 산정(2D or 3D Scan) 컨설팅</p>
                </div>
              </li> 
            </ul>
            </li>
            <li className={`${selectedLiIndex === 1 ? 'block' : 'hidden'}`}>{/*중대재해처벌법 컨설팅 */}
              <div className="w-full h-24 border-t-4 border-secondary flex justify-start items-center pl-10 text-black font-medium mb-7 text-[26px]">
                중대재해처벌법 컨설팅
              </div>
              ...
              <li className="w-full border-b border-gray flex">
                ...
                <div className="w-1/2 h-32 flex items-center">
                  ...
                  <p className="ml-3">
                    중대재해처벌법 및 산업안전보건법을 적절하게 이행하고 있는지<br />
                    확인하고자 하는 사업장
                  </p>
                </div>
              </li>
              ...
              <div className="flex justify-between text-[14px] text-primary mb-10">
                <div className="w-1/3 h-56 border border-secondary rounded-md text-center py-10">
                  <strong className="text-secendary text-[26px]">안전보건관리체계</strong>
                  <p className="mt-7">
                  <span className="block w-24 h-0 border-t border-primary m-auto mb-7">{""}</span>
                  안전관리조직 구성 및 운영실태를 파악 및 분석하여,<br />
                  적합한 안전보건관리체계 구축 방안 제시</p>
                </div>
                <div className="w-1/3 h-56 border border-secondary rounded-md text-center py-10 mx-5">
                  <strong className="text-secendary text-[26px]">안전관리시스템(PDCA)</strong>
                  <p className="mt-7">
                  <span className="block w-24 h-0 border-t border-primary m-auto mb-7">{""}</span>
                  안전관리시스템 구축현황 및 운영실태를 점검하여,<br />
                  보다 효율적인 안전관리시스템 구축 및 운영방안 제시</p>
                </div>
                <div className="w-1/3 h-56 border border-secondary rounded-md text-center py-10">
                  <strong className="text-secendary text-[26px]">안전한 작업환경</strong>
                  <p className="mt-7">
                  <span className="block w-24 h-0 border-t border-primary m-auto mb-7">{""}</span>
                  현장진단을 통한<br />
                  잠재유해위험요인 발굴 및 개선방안 제시</p>
                </div>
              </div>
                  ...
                  <li>
                    ...
                    <div className="border-x border-primary w-full p-6 flex">
                      <div className="w-1/2">
                        ...
                        <p className="text pl-2 mt-1">· 안전관리책임자 선임 등 문서관리 상태 파악</p>
                        <p className="text pl-2">· 운영상태 및 이행여부</p>
                        <p className="text pl-2 mb-3">· 산안법/연안법 위반 여부</p>
                      </div>
                      <div className="w-1/2">
                        <strong className="text-[18px] font-medium">
                          <Image src={content_icon} className="w-5 inline-block" alt="텍스트 강조"/>
                        ...
                        <p className="text pl-2 mt-1">· 위험성평가, 작업 시작 전 점검, 비상조치계획 등에 대한 서류 점검 진행</p>
                      </div>  
                    </div>
                  </li>
                  <li>
                    ...
                    <div className="border-x border-primary w-full p-6 flex">
                      <div className="w-1/2">
                        ...
                        <p className="text pl-2 mb-3 mt-1">· 산업안전보건법, 시행령, 시행규칙 이행여부</p>
                      </div>
                      <div className="w-1/2">
                        <strong className="text-[18px] font-medium">
                          <Image src={content_icon} className="w-5 inline-block" alt="텍스트 강조"/>
                        ...
                        <p className="text pl-2 mt-1">· 산업안전보건기준 규칙 준수여부</p>
                        <p className="text pl-2">· 위험요인 및 법규 위반·지적 사항</p>
                        <p className="text pl-2">· 기계, 전기, 화공 분야 심층분석</p>
                      </div>
                    </div>
                  </li>
                  <li>
                    ...
                    <div className="border border-t-0 border-primary w-full p-6 flex">
                      ...
                      <p className="text pl-2 mt-1">· 문서관리 및 운영상태 개선안 제시</p>
                      <p className="text pl-2">· 위험성평가, 작업 시작 전 점검 등 서류 보완사항 제시</p>
                      </div>
                      <div className="w-1/2">
                      <strong className="text-[18px] font-medium">
                        <Image src={content_icon} className="w-5 inline-block" alt="텍스트 강조"/>
                      ...
                      <p className="text pl-2 mt-1">· 산업안전보건법 및 하위법령에 따른 개선안</p>
                      <p className="text pl-2">· 기계, 전기, 화공 분야 심층적 개선안</p>
                      </div>
                    </div>
                  </li>
                </ul>
            ...
            <li className={`${selectedLiIndex === 2 ? 'block' : 'hidden'}`}>{/*위험성 평가 */}
            <div className="w-full h-24 border-t-4 border-secondary flex justify-start items-center pl-10 text-black font-medium mb-7 text-[26px]">
                산업현장 위험성평가
              </div>
              ...
              <div className="flex justify-between text-[15px] text-primary mb-10">
                <div className="w-full h-64 border border-secondary rounded-md text-center py-10">
                  <strong className="text-secendary text-[26px]">위험성평가 실시</strong>
                  <p className="py-7 px-12 text-left">
                  <span className="block w-48 h-0 border-t border-primary m-auto mb-7">{""}</span>
                  산업안전보건법 제36조에 의거 사업주는 건설물, 기계·기구·설비, 원재료, 가스, 증기, 분진, 근로자의 작업행동 또는 그 밖의 업무로 인한 
                  유해·위험 요인을 찾아내어 부상 및 질병으로 이어질 수 있는 위험성의 크기가 허용 가능한 범위인지를 평가하여야 하고, 그 결과에 따라 
                  관계법령에 의한 조치와 더불어 근로자에 대한 위험 또는 건강장해를 방지하기 위하여 필요한 경우 추가적인 조치를 하여야 하며, 
                  위험성평가를 실시한 경우에는 평가의 결과와 조치사항을 기록·보존하도록 되어 있습니다.</p>
                </div>
              </div>
              ...
              <div className="w-full mb-10">
                <table className="w-full text-center border-t-2 border-secondary">
                  ...
                  <tr className="h-16 border-b border-gray">
                    ...
                    <td className="text-left pl-6">최초평가 후 매년 정기적으로 실시</td>
                  </tr>
                  <tr className="border-b-2 border-gray">
                    ...
                    <td className="text-left p-6 leading-7">
                      ...
                      <p className="leading-3">&nbsp;&nbsp;&nbsp;(휴업 이상의 요양을 요하는 경우에 한정)</p>
                      <p className="mt-2">· 그 밖에 사업주가 필요하다고 판단한 경우</p>
                    </td>
                  </tr>
                </table>
              </div>
                  ...
                  <li>
                    ...
                    <div className="border-x border-primary w-full p-6 flex">
                      ...
                      <div className="w-1/2">
                        ...
                        <p className="text pl-2 mt-1">· 평가에 필요한 안전·보건 정보 수집</p>
                      </div>
                    </div>
                  </li>
                  <li>
                    ...
                    <div className="border border-t-0 border-primary w-full p-6 flex">
                      ...
                      <p className="text pl-2 mt-1">· 작업과 관계되는 유해·위험 요인 파악 및 위험성 추정</p>
                      <p className="text pl-2">· 허용 가능한 위험성 기준과 비교하여 위험성 결정</p>
                      </div>
                    </div>
                  </li>
                  <li>
