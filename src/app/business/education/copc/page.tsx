        ...
        <section className="py-[20px]  pl-[40px] w-full flex flex-col justify-start items-start">
          ...
          <ul className="w-full flex flex-wrap">
            <li
              ...
              IECEx 000
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 0 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5 
              ${selectedLiIndex === 1 ?
              ...
              IECEx 001
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 1 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5
              ${selectedLiIndex === 2 ?
              ...
              IECEx 002
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 2 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5
              ${selectedLiIndex === 3 ?
              ...
              IECEx 009
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 3 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5
              ${selectedLiIndex === 4 ?
              ...
              IECEx 003/006
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 4 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5
              ${selectedLiIndex === 5 ?
              ...
              IECEx 004/007/008
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 5 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5
              ${selectedLiIndex === 6 ?
              ...
              IECEx 005
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 6 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5
              ${selectedLiIndex === 7 ?
              ...
              IECEx 002/009
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 7 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
            <li
              className={`w-1/4 h-14 flex justify-between items-center pl-5
              ${selectedLiIndex === 8 ?
              ...
              <Image src={content_icon} className={`w-6 mr-5 ${selectedLiIndex === 8 ? 'inline-block' : 'hidden'}`} alt="선택 아이콘"/>{''}
            </li>
          </ul>
          <ul className="w-full mt-10">
            <li className={`${selectedLiIndex === 0 ? 'block' : 'hidden'}`}>{/*첫번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Unit 000 수료증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
                <p>· 역량을 입증한 개인에게 수료증을 발급하여 방폭 분야 초급 인력 양성</p>
              </div>
              <ContentSubTitle title="교육 내용" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 국제 방폭 전문가 과정(IECEx CoPC)에 응시하기 전 방폭에 대한 이해도를 향상시키기 위한 교육과정</p>
                <p>· 방폭 기본 개념 및 방폭 전문 인력 인증 자격증 취득 과정에 관한 전반적인 지식 제공</p>
              </div>
              <ContentSubTitle title="교육 대상" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
              ...
              <div className="w-full h-64 border-t-2 border-superdarkgray flex">
                <div className="w-1/6 flex justify-center items-center bg-lightgray font-medium text-black border-b border-gray">
                  1일차
                </div>
                <div className="w-5/6 h-full border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
            ...
            <li className={`${selectedLiIndex === 1 ? 'block' : 'hidden'}`}>{/*두번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Unit 001 합격증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <div className="w-full h-68 border-t-2 border-superdarkgray flex flex-wrap">
                ...
                <div className="w-5/6 h-16 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
                  <p>· 이론 평가</p>
                </div>
              </div>
            </li>
            <li className={`${selectedLiIndex === 2 ? 'block' : 'hidden'}`}>{/*세번째 li */}
              ...
              <ContentSubTitle title="교육 개요" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 및 실습 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Unit 002 합격증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                ...
                <p>· 인화성 물질에 대한 공정, 장비, 안전, 전기, 기계 분야 관련 학위, 졸업장 또는 동등 자격 소유자</p>
              </div>
              <ContentSubTitle title="합격 기준" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 이론 평가는 객관식과 주관식으로 이루어지며 오픈 북 (Open Book) 시험으로 키워드 (Keyword) 미작성 시 감점 요인이 됨</p>
            ...
            <li className={`${selectedLiIndex === 3 ? 'block' : 'hidden'}`}>{/*네번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 및 실습 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Unit 009 합격증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <ContentSubTitle title="교육 대상" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx CoPC 001 자격 소유자, 관련 분야 2년제 대학 학위 이상 소지자 또는 동등 자격 보유자</p>
                <p>· 일반 전기 분야 설치/설계 또는 폭발위험지역 설치/설계 3년 이상 실무경력 보유자</p>
              </div>
              <ContentSubTitle title="합격 기준" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 이론 평가는 객관식과 주관식으로 이루어지며 오픈 북 (Open Book) 시험으로 키워드 (Keyword) 미작성 시 감점 요인이 됨</p>
              ...
              <div className="w-full h-72 border-t-2 border-superdarkgray flex flex-wrap">
                ...
                <div className="w-5/6 h-60 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
            ...
            <li className={`${selectedLiIndex === 4 ? 'block' : 'hidden'}`}>{/*다섯번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 및 실습 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Units 003, 006 합산 합격증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <div className="w-full border-t-2 border-superdarkgray flex flex-wrap">
                ...
                <div className="w-5/6 h-40 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
                  <p>· 방폭 구역 내 안전 작업 절차</p>
                  <p>· 방폭 구역 요구 조건에 따른 방폭장비의 선정</p>
                  <p>· 방폭 장비 설치에 대한 문서 작성</p>
                  <p>· 케이블 포설과 결선에 대한 요구사항</p>
                </div>
                <div className="w-1/6 flex h-32 justify-center items-center bg-lightgray font-medium text-black border-b border-gray">
                  2일차
                </div>
                <div className="w-5/6 h-32 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
            ...
            <li className={`${selectedLiIndex === 5 ? 'block' : 'hidden'}`}>{/*여섯번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 및 실습 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Units 004, 007, 008 합산 합격증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx CoPC 001 자격 소유자, 관련 분야 2년제 대학 학위 이상 소지자 또는 동등 자격 보유자</p>
                <p>· 전기 설비 또는 방폭 설비 유지/보수 3년 이상 실무경력 보유자</p>
              </div>
              <ContentSubTitle title="합격 기준" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 이론 평가는 객관식과 주관식으로 이루어지며 오픈 북 (Open Book) 시험으로 키워드 (Keyword) 미작성 시 감점 요인이 됨</p>
              ...
              <ContentSubTitle title="교육 프로그램"/>
              <div className="w-full border-t-2 border-superdarkgray flex flex-wrap">
                <div className="w-1/6 h-48 flex justify-center items-center bg-lightgray font-medium text-black border-b border-gray">
                  1일차
                </div>
                <div className="w-5/6 h-48 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
                  <p>· 방폭 구역 내 안전 작업 절차</p>
                  <p>· 방폭 구역 요구 조건에 따른 방폭 장비의 선정 적합성 진단</p>
                  <p>· 방폭 장비 유지보수에 대한 문서 작성</p>
                  <p>· 방폭 장비 설치와 케이블 포설 및 결선에 대한 요구 사항</p>
                  <p>· 위험 지역 내 혹은 연관 구역에서의 세부 검사</p>
                </div>
                <div className="w-1/6 flex h-24 justify-center items-center bg-lightgray text-bold text-black border-b border-gray">
                  2일차
                </div>
                <div className="w-5/6 h-24 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
            ...
            <li className={`${selectedLiIndex === 6 ? 'block' : 'hidden'}`}>{/*일곱번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 및 실습 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Unit 005 합격증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <ContentSubTitle title="교육 대상" />
              <div className="w-full h-[120px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx CoPC 001 자격 소유자, 관련 분야 2년제 대학 학위 이상 소지자 또는 동등 자격 보유자</p>
                <p>· 방폭 장비 설계, 설비 제조자, 관리자 및 수리업체, 전기 설치와 수리, 보수와 관련된 교육 수료 등
                  최소 3년 이상의 관련 업무 실무경력 보유자<br />
              ...
              <div className="w-full border-t-2 border-superdarkgray flex flex-wrap">
                ...
                <div className="w-1/6 flex h-48 justify-center items-center bg-lightgray font-medium text-black border-b border-gray">
                  2일차
                </div>
                <div className="w-5/6 h-48 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
                  <p>· 초기검사의 정의 및 세부사항</p>
            ...
            <li className={`${selectedLiIndex === 7 ? 'block' : 'hidden'}`}>{/*여덟번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 및 실습 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Unit 002, 009 합산 수료증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <ContentSubTitle title="교육 프로그램"/>
              <div className="w-full border-t-2 border-superdarkgray flex flex-wrap">
                <div className="w-1/6 h-64 flex justify-center items-center bg-lightgray font-medium text-black border-b border-gray">
                  1일차
                </div>
                <div className="w-5/6 h-64 border-b border-l border-gray flex flex-col justify-center pl-5 leading-7">
                  <p>· 폭발위험구역 구분 이론</p>
                  <p>· 방폭 구역 내 안전 작업 절차</p>
            ...
            <li className={`${selectedLiIndex === 8 ? 'block' : 'hidden'}`}>{/*아홉번째 li */}
              ...
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx 60079 시리즈 및 OD 504에 언급되어 있는 기초 방폭 이론 및 실습 교육</p>
                <p>· IECEx OD 504에 근거한 IECEx CoPC Unit 002, 008, 009, 010 합산 합격증 발급 교육</p>
              </div>
              <ContentSubTitle title="교육 목적" />
              <div className="w-full h-[60px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 전 산업 분야 역량 확보를 위한 방폭 관련 전문가 양성과 전문지식 배양을 통한 역량 강화</p>
              ...
              <ContentSubTitle title="교육 대상" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· IECEx CoPC 001 자격 소유자, 전기설치 또는 검사 실무 최소 3년의 경력</p>
                <p>· 폭발위험지역 내 설치 또는 검사 업무 관련 최소 2년 이상  실무 경력 보유자</p>
              </div>
              <ContentSubTitle title="합격 기준" />
              <div className="w-full h-[90px] border border-gray flex flex-col justify-center pl-5 leading-7 mb-7">
                <p>· 이론 평가는 객관식과 주관식으로 이루어지며 오픈 북 (Open Book) 시험으로 키워드 (Keyword) 미작성 시 감점 요인이 됨</p>
              ...
              <ContentSubTitle title="교육 프로그램"/>
              <div className="w-full border-t-2 border-superdarkgray flex flex-wrap">
                <div className="w-1/6 h-32 flex justify-center items-center bg-lightgray font-medium text-black border-b border-gray">
                  1일차
                </div>
                <div className="w-5/6 h-32 border-b border-l border-gray flex flex-col justify-center pl-5 leading-8">
                  <p>· 방폭의 기본 원리</p>
