    ...
    <section>
      ...
      <main className="w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="py-[20px]  pl-[40px] w-full flex flex-col justify-start items-start">
          ...
          <div className="px-[20px] flex w-full my-[15px] text-[15px]">
            <div className="w-[90px] text-subtitle bg-gray flex justify-center items-center">
              중급
            </div>
            <div className="w-[30%] pt-[10px] px-[10px] flex flex-col justify-start items-start border-r border-t border-b border-gray pb-[10px]">
              <span>한국방폭협회 방폭 기초교육 이수자</span>
