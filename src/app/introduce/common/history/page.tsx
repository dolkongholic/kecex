      ...
      <main className="w-[1400px] flex justify-between items-start m-auto">
        ...
        <section className="p-[20px] w-full flex flex-col justify-start items-start">
          ...
          <div className="w-full px-[20px] h-[50px] flex">
            ...
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">2023.06</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">(사)한국방폭협회 설립 인가</div>
          </div>
          <div className="w-full px-[20px] h-[50px] flex">
            <div className="w-[30%] flex justify-end text-right items-center mr-[10px] text-black">&nbsp;</div>
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">2023.02</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">고용노동부 산하 협회 인가 추진</div>
          </div>
          ...
          <div className="w-full px-[20px] h-[50px] flex">
            <div className="w-[30%] flex justify-end text-right items-center mr-[10px] text-black">한국방폭협회 창립총회 및 세미나</div>
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">2022.11</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">&nbsp;</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">&nbsp;</div>
          ...
          <div className="w-full px-[20px] h-[50px] flex">
            <div className="w-[30%] flex justify-end text-right items-center mr-[10px] text-black">한국조선해양기자재연구원 MOU체결</div>
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">2022.10</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">&nbsp;</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">&nbsp;</div>
          ...
          <div className="w-full px-[20px] h-[50px] flex">
            <div className="w-[30%] flex justify-end text-right items-center mr-[10px] text-black">한국방폭산업안전연구회 준비위원 간담회 개최</div>
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">2022.09</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">&nbsp;</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">&nbsp;</div>
          ...
          <div className="w-full px-[20px] h-[100px] flex">
            <div className="w-[30%] flex justify-end text-right items-center mr-[10px] text-black">헥사곤, 화학네트워크포럼 산업안전 및<br/>방폭산업 발전 모색 세미나 개최</div>
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">2022.05<br/></div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">&nbsp;</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">&nbsp;</div>
          ...
          <div className="w-full px-[20px] h-[150px] flex">
            <div className="w-[30%] flex justify-end text-right items-center mr-[10px] text-black">울산과학대학교, 한국가스안전공사 울산본부,<br/>한국산업인력공단 울산지사, <br/>중소기업융합울산연합회,<br/>공장장협의회 MOU체결</div>
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">2022.04<br/><br/><br/><br/></div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">&nbsp;</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">&nbsp;</div>
          ...
          <div className="w-full px-[20px] h-[50px] flex">
            <div className="w-[30%] flex justify-end text-right items-center mr-[10px] text-black">한국방폭산업안전연구회 창립총회</div>
            <div className="w-[10%] flex justify-end text-right items-center mr-[10px]">2022.02</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold border-r border-gray px-[10px] ">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px] text-title text-secondary font-bold pl-[10px]">&nbsp;</div>
            <div className="w-[10%] flex justify-start items-center mr-[10px]">&nbsp;</div>
            <div className="w-[30%] flex justify-start items-center mr-[10px] text-black">&nbsp;</div>
