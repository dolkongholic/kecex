          ...
          <div className="text-black w-full flex flex-col justify-between item-center -translate-y-[19px]">
            <div className="h-[200px] bg-lightgray p-[30px] flex justify-between">
              ...
              <ul className="w-[520px] flex">
                <a href="/mypage/overall/all01"><li className="w-[130px] h-[130px] border border-gray flex flex-col justify-center items-center">
                  ...
                  <p className="text-[13px] h-[40px]">발급/출력 현황</p>
                </li></a>
                ...
                <a href="/mypage/overall/all03"><li className="w-[130px] h-[130px] border border-secondary bg-white flex flex-col justify-center items-center">
                  <div className="w-12 h-12 bg-white rounded-full flex justify-center items-center m-2">
                    <p className="text-[20px] font-bold text-secondary">0</p>
                  </div>
                  <p className="text-[13px] h-[40px] text-secondary font-semibold">세미나/컨설팅<br/>신청 현황</p>
                </li></a>                
            ...
            <h3 className="font-bold mt-16 text-[16px]">세미나/컨설팅 신청 현황</h3>
