      ...
      <div>
        ...
        <div className='mt-6'>
          <button
            ...
            className='w-full bg-primary transform rounded-md bg-gray-700 px-4 py-2 tracking-wide text-white transition-colors duration-200 hover:bg-gray-600 focus:bg-gray-600 focus:outline-none'
          >
            Log In
          </button>
        </div>
