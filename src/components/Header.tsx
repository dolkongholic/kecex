...
export default function Header({ menu, setMenu }: Props) {
  ...
  return (
    <>
      ...
      {/* -----------전체화면 시작----------------------- */}
      <div
        className={`w-full h-full fixed z-[800] bg-white top-0 left-0 overflow-y-auto scrollbar-hide transition-opacity duration-100 ease-in-out ${
